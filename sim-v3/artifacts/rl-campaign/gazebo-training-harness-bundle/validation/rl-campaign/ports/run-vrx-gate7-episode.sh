...
ros2 run ros_gz_bridge parameter_bridge \
  ...
  '/surveyor/thrusters/port/thrust/ang_vel@std_msgs/msg/Float64[gz.msgs.Double' \
  '/surveyor/thrusters/starboard/thrust/ang_vel@std_msgs/msg/Float64[gz.msgs.Double' \
