...
class CommonWaypointEnv(gym.Env):
 ...
 EXPECTED_CONTRACT_SHA256="d586a0473bdafdea67968e301e1b757220258b0d45a4c74d2f35b7b5e6a4dc85"
 ...
 def _obs(self):
  target=self.route[self.waypoint];imu_payload=self._fresh_sensor("imu");gps_payload=self._fresh_sensor("gps");imu=[0.]*7;gps=[0.]*5
  ...
  if gps_payload is not None:
   n,e=gps_payload["position_ned_m"][:2];vn,ve=gps_payload["velocity_ned_mps"][:2];gps=[target[0]-n,target[1]-e,vn,ve,1.]
