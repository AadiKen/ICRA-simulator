...
class CommonWaypointEnv(gym.Env):
 ...
 def __init__(self,repository:str|Path,base_seed:int=0,fixed_reset_seed:int|None=None,final_leg_curriculum:bool=False,shaping_enabled:bool=True,bridge=None,backend_type:str="node",disturbance_mode:str="seeded"):
