...
export class LegacyProductionEngine implements SimulationEngine {
  ...
  getGroundTruth(){this.#ready();const b=this.#sim!.state.boat,velocityBody=b.rigidBody?[b.rigidBody.velocity.u,b.rigidBody.velocity.v,b.rigidBody.velocity.w]:[b.velocity.z,b.velocity.x,-b.velocity.y],c=Math.cos(b.heading),s=Math.sin(b.heading);return{time_s:this.#elapsed(),position_ned_m:[b.pos.z,b.pos.x,-b.pos.y],attitude_rad:[b.orientation.z,b.orientation.x,b.heading],velocity_body_mps:velocityBody,velocity_ned_mps:[c*velocityBody[0]-s*velocityBody[1],s*velocityBody[0]+c*velocityBody[1],velocityBody[2]],angular_rate_body_rad_s:b.rigidBody?[b.rigidBody.angularRate.p,b.rigidBody.angularRate.q,b.rigidBody.angularRate.r]:[b.angularVel.z,b.angularVel.x,b.angularVel.y],acceleration_body_mps2:b.rigidBody?[b.rigidBody.acceleration.uDot,b.rigidBody.acceleration.vDot,b.rigidBody.acceleration.wDot]:[b.acceleration.z,b.acceleration.x,-b.acceleration.y]};}
