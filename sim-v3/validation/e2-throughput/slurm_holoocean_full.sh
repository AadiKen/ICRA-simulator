...
.venv/bin/python validation/e2-throughput/run_external_full.py --backend holoocean --counts 1 2 4 8 16 32 --output artifacts/e2-throughput/holoocean-full.json
